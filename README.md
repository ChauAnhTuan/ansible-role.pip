...
[![Build Status](https://travis-ci.org/chauanhtuandl/ansible-role.pip.svg?branch=master)](https://travis-ci.org/chauanhtuandl/ansible-role.pip)

Installs the [Python PIP](https://pypi.org/project/pip/) for RHEL/CentOS/Debian/Ubuntu.
